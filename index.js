...
function isOwner(member) {
  return hasRole(member, ROLES.OWNER);
}
...
function getRoleName(member) {
  ...
  if (hasRole(member, ROLES.OWNER))
    return "المالك・👑";

  if (hasRole(member, ROLES.SENIOR_ADMIN))
    return "الإدارة العليا・🛡️";

  if (hasRole(member, ROLES.ADMIN))
    return "إداري・⚔️";

  if (hasRole(member, ROLES.MODERATOR))
    return "مشرف・🔰";

  if (hasRole(member, ROLES.ASSISTANT))
    return "مساعد・🛡️";
...
const commands = [
  ...
  new SlashCommandBuilder()
    .setName("points")
    .setDescription("عرض نقاط وراتب شخص")
  ...
  new SlashCommandBuilder()
    .setName("salary")
    .setDescription("عرض راتبك أو راتب شخص")
    .addUserOption(option =>
      option
        .setName("person")
        .setDescription("الشخص")
  ...
  new SlashCommandBuilder()
    .setName("profile")
    .setDescription("عرض بروفايل موظف")
    .addUserOption(option =>
      option
        .setName("person")
        .setDescription("الشخص")
  ...
  new SlashCommandBuilder()
    .setName("addpoints")
    .setDescription("إضافة نقاط لشخص")
    .addUserOption(option =>
      option
        .setName("person")
        .setDescription("الشخص")
  ...
  new SlashCommandBuilder()
    .setName("minus")
    .setDescription("خصم نقاط من شخص")
    .addUserOption(option =>
      option
        .setName("person")
        .setDescription("الشخص")
  ...
  async interaction => {
    ...
    try {
      ...
      if (interaction.isChatInputCommand()) {
        ...
        if (
          interaction.commandName === "salary"
        ) {
